...
{
    /// <summary>
    /// Writer for KiCad S-expression files. Converts a tree of LegacySExpression objects to formatted text.
    /// </summary>
    public class LegacySExpressionWriter
    {
        /// <summary>
        ...
        public string Write(LegacySExpression expression, int indentLevel = 0)
        {
        ...
        public void WriteToFile(LegacySExpression expression, string filePath)
        {
            string content = Write(expression);
            File.WriteAllText(filePath, content);
        }

        private void WriteToBuilder(LegacySExpression expression, StringBuilder sb, int indentLevel)
        {
