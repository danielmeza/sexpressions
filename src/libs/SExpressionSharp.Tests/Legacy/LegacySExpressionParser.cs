...
{
    /// <summary>
    /// Parser for KiCad S-expression files. Parses text in S-expression format into a tree of LegacySExpression objects.
    /// </summary>
    public class LegacySExpressionParser
    {
        ...
        public LegacySExpression Parse(string text)
        {
            _text = text;
            _position = 0;
        ...
        /// <returns>The root S-expression</returns>
        public LegacySExpression ParseFile(string filePath)
        {
            string text = File.ReadAllText(filePath);
            return Parse(text);
        }

        private LegacySExpression ParseExpression()
        {
            ...
            var expression = new LegacySExpression(token);
